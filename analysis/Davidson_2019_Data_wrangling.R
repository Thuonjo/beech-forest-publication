...
## ----variable-str-labels2, echo = TRUE-----------------------------------
...
## ----seed-data, message=FALSE, warning=FALSE-----------------------------
...
## ----results-output, message=FALSE, warning=FALSE------------------------
...
## ----writing-csvs, eval=FALSE, include=FALSE-----------------------------
write.csv(p.design2, "C://Code/data/mouse-summary-data.csv")
...
## ----message=FALSE, warning=FALSE----------------------------------------
# export data
write_csv(plot.dat.all1, "C://Code/data/plot-all-data1.csv")
