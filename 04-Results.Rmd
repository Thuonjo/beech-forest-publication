...
```{r pa-plot2, out.width="100%", out.height="50%",fig.cap = cap.Pa, fig.align='center'}
...
```{r pb-plot2, out.width="100%", out.height="50%",fig.cap = cap.Pb, fig.align='center'}
...
```{r, out.width="100%", out.height="50%",fig.cap = cap.Pc, fig.align='center'}
...
```{r fig-pD, fig.cap = cap.Pc, fig.align='center'}
knitr::include_graphics(c("./figs/fig-9-short.png"))
```
...
```{r pE-plo, fig.cap = cap.Pc, fig.align='center'}
knitr::include_graphics(c("./figs/rat-plot-1.png"))
```

<!-- ![The unmodified abundance of mice in non-mast years. The shape difference distinguishes the two valleys, the yellow symbols represent cases where stoats are present and absent at points with black symbols and the solid symbols represent cases where rats are present and removed at points with hollow symbols.](../beech-forest-dynamics/figs/rat-plot-1.png) -->
