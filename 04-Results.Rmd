...
```{r adding-vignette-model, message=FALSE, warning=FALSE, include=FALSE}
# knitr::purl("Davidson_2019_Simple_models.Rmd")
...
```{r, fig.cap = cap.Pc, fig.align='center'}
...
```{r fig-pD, fig.cap = cap.Pd, fig.align='center'}
...
```{r pE-plo, fig.cap = pE.cap, fig.align='center'}
